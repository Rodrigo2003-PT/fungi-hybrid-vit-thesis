...
def _smoke_test():
    ...
    # ------------------------------------------------------------------
    print("\n[1] Model instantiation (analytical grid check fires here)")
    ...
    print("\n[2] Direct tokenizer forward (ConvTokenizer only — no _runtime_token_check)")
    ...
    print("\n[3] Full model forward (SimpleViT_ConvTok.forward — _runtime_token_check fires here)")
    ...
    print("\n[4] Parameter count comparison: hidden_channels=64 (fixed) vs hidden_channels=256 (prior)")
    ...
    # ------------------------------------------------------------------
    print("\n[5] Policy B ('explicit_kaiming') — transformer body initialisation")
